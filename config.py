...
# นินจา relay: ตอบสนองแบบคน (เดิมกดภายใน 0.5 วิเป๊ะทุกครั้ง)
# นินจาเป็นตัววิ่งเคลื่อนที่ — หน่วงนานเกินไปนินจาวิ่งพ้นจุดที่ตรวจเจอ กดไม่โดน
RELAY_REACT_RANGE   = (0.08, 0.3)  # หน่วงก่อนกด (วินาที สุ่มในช่วง) — ไวพอกดโดนนินจาก่อนวิ่งพ้น
RELAY_MISS_CHANCE   = 0.05         # โอกาส "มองไม่เห็นรอบแรก" (ข้ามไป 1 cycle แล้วค่อยกด)
